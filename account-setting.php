    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="#" id="profilePicture">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400" data-bs-toggle="tooltip" data-bs-placement="top"
        ...
        <section class="section profile">
          <div class="row">
            <div class="col-xl-6 float-end ge-0">

              <div class="card w-75 mx-auto mb-3">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">

                  <img src="img/undraw_profile.svg" width="30%" alt="Profile" class="rounded-circle">
                  <h3 class="text-capitalize">
                    <?php echo $_SESSION['fname'] . ' ' . $_SESSION['lname'] ?>
                  </h3>
                  <h3>Web Designer</h3>
                  <div class="social-links mt-2">
                    <a href="#" class="twitter px-3"><i class="bi bi-twitter"></i></a>
                    <a href="#" class="facebook px-3"><i class="bi bi-facebook"></i></a>
                    <a href="#" class="instagram px-3"><i class="bi bi-instagram"></i></a>
              ...
              <div class="card">
                <div class="card-body pt-3">
                  ...
                  <div class="tab-content pt-2">
                    ...
                    <div class="py-5 tab-pane fade show active profile-overview" id="profile-overview">
                      ...
                      <div class="row py-3">
                        <div class="col-lg-3 col-md-4 label fw-bold text-muted">Company</div>
                        <div class="col-lg-9 col-md-8">Lueilwitz, Wisoky and Leuschke</div>
                      </div>

                      <div class="row py-3">
                        <div class="col-lg-3 col-md-4 label fw-bold text-muted">Job</div>
                      ...
                      <div class="row py-3">
                        <div class="col-lg-3 col-md-4 label fw-bold text-muted">Address</div>
                        <div class="col-lg-9 col-md-8">A108 Adam Street, New York, NY 535022</div>
                      </div>

                      <div class="row py-3">
                        <div class="col-lg-3 col-md-4 label fw-bold text-muted">Phone</div>
                      ...
                      <form>
                        <div class="row mb-3">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <img src="img/undraw_profile.svg" width="30%" alt="Profile">
                            <div class="pt-2">
                              <button type="button" class="btn btn-primary">
                                <input type="file" id="upload-icon" name="profile" class="form-control d-none"><label
                                  for="upload-icon"><i class="bi bi-upload"></i></label></button>
